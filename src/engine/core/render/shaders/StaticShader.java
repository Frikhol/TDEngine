...
public class StaticShader extends ShaderProgram{
    ...
    private static final String VERTEX_FILE = "src/engine/core.render.shaders/vertexShader.txt";
    private static final String FRAGMENT_FILE = "src/engine/core.render.shaders/fragmentShader.txt";
