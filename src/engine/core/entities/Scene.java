...
import core.entities.components.Material;
...
public class Scene {
    ...
    private GUI currentGUI; //TODO GUI->GUIFrame
    private List<Light> lights = new ArrayList<>();
    private Camera camera;
    private InputList inputList = null; //TODO inputList->inputSettings (реализовать паттерн Команда)
